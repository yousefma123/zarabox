...
<head>
    ...
    <link rel="stylesheet" href="<?= $url ?>/includes/layouts/css/ow-carousel.css">
    <link rel="stylesheet" href="<?= $url ?>/includes/layouts/css/all.min.css">
    <link rel="stylesheet" href="<?= $url ?>/includes/layouts/css/pe-icons.css">
